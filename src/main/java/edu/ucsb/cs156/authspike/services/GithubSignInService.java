...
@Service
public class GithubSignInService extends DefaultOAuth2UserService {

    private final UserRepository userRepository;

    private final CurrentUserService currentUserService;

    public GithubSignInService(@Autowired UserRepository userRepository, @Autowired CurrentUserService currentUserService) {
    ...
    private OAuth2User attachGithubSignin(OAuth2User oAuth2User) {
        ...
        if(authentication != null){
            ...
            User currentLocalUser = currentUserService.getCurrentUser();
            if(currentLocalUser != null){
                currentLocalUser.setGithubId((int) oAuth2User.getAttributes().get("id"));
